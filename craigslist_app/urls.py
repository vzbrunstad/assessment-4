...
urlpatterns = [
    path('', views.category_list, name = 'category_list' ),# /categories: A page listing all the categories
    ...
    path('<int:category_id>/posts/<int:post_id>', views.post_detail, name='post_detail'),# /categories/:category_id/posts/:post_id: A page to view the detail of a specific post. Also include the ability go back to the parent category detail page (/categories/:category_id/)
